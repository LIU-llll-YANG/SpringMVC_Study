...
![29](https://lsky.liuyangyyds.cn/i/2023/02/17/63ef17d492ecb.png)
...
![30](https://lsky.liuyangyyds.cn/i/2023/02/17/63ef169ba75c3.png)
...
![31](https://lsky.liuyangyyds.cn/i/2023/02/17/63ef16a126a42.png)
...
![32](https://lsky.liuyangyyds.cn/i/2023/02/17/63ef16a5800cf.png)
...
```java
package com.liuyang.mvc.dao;
import java.util.Collection;
import java.util.HashMap;
import java.util.Map;
import com.liuyang.mvc.bean.Employee;
...
```xml
<bean class="com.liuyang.interceptor.FirstInterceptor"></bean>
...
@Configuration
//扫描组件
@ComponentScan("com.liuyang.mvc.controller")
//开启MVC注解驱动
@EnableWebMvc
...
![33](https://lsky.liuyangyyds.cn/i/2023/02/17/63ef16c6ea16e.png)
...
![35](https://lsky.liuyangyyds.cn/i/2023/02/17/63ef16dc04e3b.png)
...
![37](https://lsky.liuyangyyds.cn/i/2023/02/17/63ef16e165a0a.png)
...
```xml
<!--扫描组件-->
<context:component-scan base-package="com.liuyang.ssm.controller">
...
<mapper namespace="com.liuyang.ssm.mapper.EmployeeMapper">
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <!--扫描组件-->
    <context:component-scan base-package="com.liuyang.ssm">
    ...
    <bean class="org.mybatis.spring.SqlSessionFactoryBean">
        ...
        <!-- 设置类型别名所对应的包 -->
        <property name="typeAliasesPackage" value="com.liuyang.ssm.pojo">
        </property>
        <!--
            设置映射文件的路径
    ...
    <bean class="org.mybatis.spring.mapper.MapperScannerConfigurer">
        <property name="basePackage" value="com.liuyang.ssm.mapper"></property>
    </bean>
</beans>
```
